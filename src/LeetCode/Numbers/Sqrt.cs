...
/*
    ...
    - (MySqrt) Перемножение 2-х int храним в long во избежание переполнения
    - (MySqrt) Если x имеет дробный корень, то округляем до меньшего (возвращаем r, поскольку l будет на 1 больше)
*/

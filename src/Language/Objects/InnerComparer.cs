namespace HowProgrammingWorksOnDotNet.Language.Objects.Inner;
...
public class Machine
{
    ...
    public static IComparer<Machine> ComparerByWeight() => new MachineComparer();

    private class MachineComparer : IComparer<Machine>
    {
...
public class InnerComparer
{
    ...
    public void Usage()
    {
        ...
        var comparer = Machine.ComparerByWeight();
